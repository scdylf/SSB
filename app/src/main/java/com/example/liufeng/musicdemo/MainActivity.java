package com.example.liufeng.musicdemo;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private int flag = 0;  //0:代表中文，1:代表俄文，2:代表英文
    private String name_china = "xiaoyan";
    private String name_eng = "vimary";
    private String name_e = "vixr";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AdManager.getInstance(this).init("a8999282bd19a683", "5cffaf6f269762ad", true);

        /**
         **加载控件，并且初始化
         **/
        tvchina = findViewById(R.id.tvchina);
        tvchina.setTextColor(Color.parseColor("#FF4500"));
        SpeechUtility.createUtility(this, "appid=5bd18eb3");
        setupBanner();
        initView();
        initEvent();
    }
    ...
    public void setupBanner(){
        ...
        // 获取要嵌入的布局
        LinearLayout bannerLayout = findViewById(R.id.ll_banner);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.tve:
                ...
                tve.setTextColor(Color.parseColor("#FF4500"));
                tveng.setTextColor(Color.parseColor("#FFFFFF"));
                break;
            case R.id.tveng:
                flag = 2;
                start("英文版",name_china);
                tvchina.setTextColor(Color.parseColor("#FFFFFF"));
                tve.setTextColor(Color.parseColor("#FFFFFF"));
                tveng.setTextColor(Color.parseColor("#FF4500"));
                try {
                    Thread.sleep(1000);
                } catch (InterruptedException e) {
                    e.printStackTrace();
                }
                start("English version",name_eng);
                break;
            /**
             * 数字0-9
             */
...
//                    Log.d("Anonymous", "onClick: " + "进入减法方法");
            ...
            case R.id.equal_btn:
                ...
                if (flag==0){
                    start(existedText,name_china);
                }else if (flag==1){
                    start(existedText,name_e);
                }else if (flag==2){
                    if (existedText.startsWith("-")){
                        start("Negative"+existedText,name_eng);
                    }else {
                        start(existedText,name_eng);
                    }
                }
     ...
     * 判断选择语言版本
     */
    public void select_language(String value){
        if (flag==0){
            start(value,name_china);
        }else if (flag==1){
            start(value,name_e);
        }else if (flag==2){
            start(value,name_eng);
        }
    }
     ...
     * 播报计算结果方法{播报}
     */
    public void start(String result, String name){
        mTts = SpeechSynthesizer.createSynthesizer(this,null);
        mTts.setParameter(SpeechConstant.VOICE_NAME,name);
//        mTts.setParameter(SpeechConstant.LANGUAGE,"zn_ch");
        mTts.setParameter(SpeechConstant.SPEED,"50");
        mTts.setParameter(SpeechConstant.VOLUME,"80");
        mTts.setParameter(SpeechConstant.ENGINE_TYPE,SpeechConstant.TYPE_CLOUD);
        mTts.startSpeaking(result, listener);
    }
